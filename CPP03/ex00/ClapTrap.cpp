...
void ClapTrap::attack(const std::string &target) {
    ...
    if(hitPoints <= 0) {
        std::cout << name <<" can't attack. No hit points left" << std::endl;
    }
    else {
...
void ClapTrap::takeDamage(unsigned int amount) {
    if(energyPoints <= 0) {
        std::cout << name <<" can't take damage. No energy points left" << std::endl;
    }
    if(hitPoints <= 0) {
        std::cout << name <<" can't take damage. No hit points left" << std::endl;
    }
    else {
...
void ClapTrap::beRepaired(unsigned int amount) {
    if(energyPoints <= 0) {
        std::cout << name <<" can't be repaired. No energy points left" << std::endl;
    }
    if(hitPoints <= 0) {
        std::cout << name <<" can't be repaired. No hit points left" << std::endl;
    }
    else {
